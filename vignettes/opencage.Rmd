...
Please note, however, that \pkg{opencage} always caches the data it receives from the OpenCage API locally, but only for as long as your R session is alive (see below).
